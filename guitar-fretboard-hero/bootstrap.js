(() => {
  'use strict';
  const CATALOG={
    'guitar':{instrumentKey:'guitar',instrument:'./instruments/guitar.js?v=10.5.0',productKey:'guitar',product:'./products/guitar-fretboard-hero.js?v=10.5.0'},
    'bass-4':{instrumentKey:'bass4',instrument:'./instruments/bass-4.js?v=10.5.0',productKey:'bass',product:'./products/bass-fretboard-hero.js?v=10.5.0'},
    'ukulele':{instrumentKey:'ukulele',instrument:'./instruments/ukulele.js?v=10.5.0',productKey:'ukulele',product:'./products/ukulele-fretboard-hero.js?v=10.5.0'},
    'guitar-12':{instrumentKey:'guitar12',instrument:'./instruments/guitar-12.js?v=10.5.0',productKey:'guitar',product:'./products/guitar-fretboard-hero.js?v=10.5.0'}
  };
  const CORE=['music-theory','circle-of-fifths','circle-renderer','tuning','fretboard-engine','fretboard-layout','fretboard-map','pentatonic-renderer','triad-engine','arpeggio-engine','chord-engine','quiz-engine','controls','mode-registry','product-shell'].map(n=>`./core/${n}.js?v=10.5.0`);
  const MODES=['pentatonic','triads','chords','arpeggios'].map(n=>`./modes/${n}.js?v=10.5.0`);
